...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'postalAddress' => [parent::class, 'postalAddress', null, 16],
        "\0".parent::class."\0".'profilePhotoUrl' => [parent::class, 'profilePhotoUrl', null, 16],
        ...
        'postalAddress' => [parent::class, 'postalAddress', null, 16],
        'profilePhotoUrl' => [parent::class, 'profilePhotoUrl', null, 16],
